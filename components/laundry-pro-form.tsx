...
import { X, Briefcase, ChevronUp } from "lucide-react"
    ...
    <>
      ...
      <div className="hidden md:block">
        {isCollapsed ? (
          ...
          <div className="fixed top-48 left-4 z-40">
            <button
              onClick={handleExpandForm}
              className="bg-green-400 hover:bg-green-500 text-gray-900 font-semibold py-3 px-6 rounded-lg shadow-lg transition-all duration-300 flex items-center space-x-2"
            >
              <Briefcase size={20} />
              <span>Join as Laundry Folding Pro</span>
              <ChevronUp size={16} />
            </button>
          </div>
        ) : (
          // Expanded state - show full form
          <div className="fixed top-48 left-4 bg-white/95 backdrop-blur-sm p-6 rounded-lg shadow-lg border z-40 w-80 transition-all duration-300">
